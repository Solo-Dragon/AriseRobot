...
@ARISE.on_message(filters.user(NIGGERS) & ~filters.forwarded & ~filters.via_bot & filters.command("shutup"))
...
@ARISE.on_message(filters.user(NIGGERS) & ~filters.forwarded & ~filters.via_bot & filters.command("speak"))
...
@ARISE.on_message(filters.user(NIGGERS) & filters.command("del"))
